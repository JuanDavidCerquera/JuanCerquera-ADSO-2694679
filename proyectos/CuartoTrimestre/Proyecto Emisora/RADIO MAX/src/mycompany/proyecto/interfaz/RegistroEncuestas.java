...
public class RegistroEncuestas extends javax.swing.JFrame {
    DefaultTableModel modeloTabla = new DefaultTableModel(); 

    public RegistroEncuestas() {
 ...
 this.repaint();
          this.setExtendedState(RegistroEncuestas.MAXIMIZED_BOTH);
        modeloTabla.addColumn("Nombre");
        modeloTabla.addColumn("Telefono");
        modeloTabla.addColumn("Numero de Documento");
        modeloTabla.addColumn("Artista favorito");
        modeloTabla.addColumn("Cancion favorita");
        modeloTabla.addColumn("Segunda cancion favorita");
        modeloTabla.addColumn("Tercer cancion favorita");
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Administracion in = new Administracion();
        in.setVisible(true);
        this.dispose();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
            ...
            modeloTabla.addRow(new Object[] {user.getNombre(),user.getNumeroCelular(),user.getNumeroDocumento(),user.getArtista(),user.getCancion1(),user.getCancion2(),user.getCancion3()});
